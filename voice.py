...
class Validate(unittest.TestCase):
    ...
    def test_length_matches_xpost(self):
        self.assertEqual(voice.x_len("x" * 256 + " amphoodbrain.online."), xpost.x_length("x" * 256 + " amphoodbrain.online."))

    def test_url_counts_23(self):
        self.assertEqual(voice.x_len("see https://amphoodbrain.online/some/very/long/path/that/goes/on ok"), 4 + 23 + 3)
        self.assertEqual(voice.x_len("amphoodbrain.online is up"), 23 + len(" is up"))
...
class Stub(unittest.TestCase):
    ...
    def test_stub_uses_its_own_journal_file(self):
        with mock.patch.dict(os.environ, {"amphood_VOICE_MODEL": "stub", "amphood_STATE_DIR": "C:/tmp/x"}):
